        ...
        return (
          ...
          >
            ...
            <img
              ...
              loading="eager"
              decoding="async"
              className="h-full w-full select-none object-cover opacity-0 grayscale transition-[filter,scale,opacity] duration-500 [transition-timing-function:var(--ease-out)] [@media(hover:hover)]:group-hover:scale-[1.04] [@media(hover:hover)]:group-hover:grayscale-0"
